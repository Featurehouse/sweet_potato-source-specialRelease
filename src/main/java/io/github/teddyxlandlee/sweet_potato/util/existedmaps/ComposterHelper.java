...
public final class ComposterHelper {
    ...
    public static void register() {
		...
		//////////////// CHRISTMAS ////////////////
		Util.registerCompostableItem(0.3f, SPMXmas.CHRISTMAS_TREE_SAPLING_ITEM);
		Util.registerCompostableItem(0.3f, SPMXmas.CHRISTMAS_TREE_LEAVES_COMMON);
		Util.registerCompostableItem(0.3f, SPMXmas.CHRISTMAS_TREE_LEAVES_GIFTED);
    }
}
