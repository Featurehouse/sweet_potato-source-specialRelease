...
import io.github.teddyxlandlee.annotation.ChristmasEdited;
...
public class SPMMain implements ModInitializer {
	...
	static {
		// Item
		PEEL = Registry.register(Registry.ITEM, new Identifier(MODID, "peel"), new ChristmasSockItem(new Item.Settings()
