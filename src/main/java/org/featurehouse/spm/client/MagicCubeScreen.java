...
public class MagicCubeScreen extends HandledScreen<MagicCubeScreenHandler> {
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        this.drawTexture(matrices, this.width, this.height, 0, 0, backgroundWidth, backgroundHeight);
        ...
        if (m >= 0) this.drawTexture(matrices, this.width + 55,  this.height + 59, 176, 29, 18, 4);
        if (v >  0) this.drawTexture(matrices, this.width + 101, this.height + 59, 176, 29, 17, 4);
        this.drawTexture(matrices, this.width + 57 , this.height + 58 - md, 199, 13 - md, 13, md);
        this.drawTexture(matrices, this.width + 105, this.height + 57 - vd, 176, 28 - vd, 10, vd);
    }
